...
import 'package:pam/page&widget/quizeEcole.dart';
import 'package:random_string/random_string.dart';

import 'searchUI.dart';
import 'userFemme.dart';
import 'userAgriculteur.dart';
import 'userEleves.dart';
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              idtypefonction == "DG" && idecole.isNotEmpty ?
              FlatButton(
                onPressed: (){
                  //Navigation push
                  Navigator.push(context, MaterialPageRoute(builder: (context) => QuizeEcole(),settings: RouteSettings(arguments: '')),);
                },
                child: Text("QUIZZ ECOLE", style: TextStyle(color: Colors.white,),),
                color: Colors.green,
                  ...
                  //color: Colors.indigo,
                    ...
                    child: Align(
                      ...
                      child: SizedBox(
                        //height: 50.0,
                        child: Text(
                          "Nombre de groupement enregistré : $n",
                          style: TextStyle(
                            fontSize: 18.0,
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return RaisedButton(
                          ...
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => UserAgriculteur(),settings: RouteSettings(arguments: '${snap[index]["id"]}')),);
                          },
                          child: Card(
                            ...
                            onPressed: () async{
                              ...
                              if(_campagneAnneeS.isNotEmpty){
                                ...
                                if(idtypeAnnee == anneeEnCour){
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => UserEleve(),settings: RouteSettings(arguments: '${snap[index]["idpersonne"]}')),);
                ...
                //color: Colors.indigo,
                  ...
                  child: Align(
                    ...
                    child: SizedBox(
                      //height: 50.0,
                      child: Text(
                        "Nombre de femme enceinte/femme allaittante enregistré : $n",
                        style: TextStyle(
                          fontSize: 18.0,
                          fontWeight: FontWeight.bold,
                        ),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return RaisedButton(
                        ...
                        disabledColor: Colors.transparent,
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => UserFemme(),settings: RouteSettings(arguments: '${snap[index]["id"]}')),);
                        },
                        child: Card(
                          margin: EdgeInsets.only(top: 25.0,),
                          elevation: 2.0,
                          child: ListTile(
                            ...
                            title: Text('${snap[index]["nom"]} ${snap[index]["prenom"]}'),
                            subtitle: Text('Femme enceinte/Femme allaittante'), //${snap[index]["idtypefonction"]}
                          ),
                        )
                    );
                  },
