                              ...
                              delegate: SliverChildBuilderDelegate(
                                    ...
                                    return idtypefonction == "DG" ?
                                      ...
                                      child: ListTile(
                                        ...
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => UserEleve(),settings: RouteSettings(arguments: '${currentItems[index]["idpersonne"]}')),);
                                        },
                                      ),
                                    ) :
                                    idtypefonction == "AA" ?
                                    Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => UserAgriculteur(),settings: RouteSettings(arguments: '${currentItems[index]["idpersonne"]}')),);
                                        },
                                      ),
                                    ) :
                                    idtypefonction == "AFE" ?
                                    Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => UserFemme(),settings: RouteSettings(arguments: '${currentItems[index]["idpersonne"]}')),);
                                        },
                                      ),
                                    ) : Container();
                                  },
