                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () async{
                        if (_formKey.currentState.validate()) {
                          ...
                          String idquestelevgen = Param.device+"-"+randomAlphaNumeric(10);
                      ...
                      onPressed: () async{
                        if (_formKey2.currentState.validate()) {
                          ...
                          await DB.insert("quiz_eleve", {
                            ...
                            "quiz6": _acces_eau_eleve != "Autre" ? _acces_eau_eleve : _acces_eau_eleve_autre.text,
                            "quiz7": latrine,
                            "datequiz": date,
                            "typequiz": "Mensuel",
                            "anneeScolaire": _campagneAnneeS[0]['description'],
